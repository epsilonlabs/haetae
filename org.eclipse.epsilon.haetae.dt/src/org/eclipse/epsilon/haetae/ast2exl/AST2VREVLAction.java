...
public class AST2VREVLAction implements IObjectActionDelegate{

	private Shell shell;

	public AST2VREVLAction() {
	...
	public void run(IAction action) {
		...
		if (!path.getFileExtension().equals("evl")) {
			MessageDialog dialog = new MessageDialog(shell, "Haetae goes woof", null,
				    "AST2VREVL converter only works for .evl files", MessageDialog.ERROR, new String[] { "OK" }, 0);
				dialog.open();
		}
		else {
