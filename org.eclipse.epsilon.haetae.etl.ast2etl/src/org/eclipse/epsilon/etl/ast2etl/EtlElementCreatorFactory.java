...
public class EtlElementCreatorFactory {
	...
	public EOLElement createEOLElement(AST ast, EOLElement container, Ast2EtlContext context)
	{
	...
	public EOLElement createEOLElement(AST ast, EOLElement container, Ast2EtlContext context, Class<? extends EOLElementCreator> ofCreatorClass)
	{
		EOLElement result = null;
		for(EOLElementCreator dec: domElementCreators)
		{
